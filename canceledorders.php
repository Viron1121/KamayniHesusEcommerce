...
else
{
         echo ' <li><a href="include/logout.php?logout_id=<?php echo $row2["unique_id"]; ?>"><i class="menu-icon icon-signout"></i>Logout</a></li>';
                ...
                <div class="span9">
                           ...
                           <h3>
                            ...
                            <div class="module-body">
                              <?php
                                ...
                                $result = $mysqli->query("SELECT * FROM canceledorders") or die($mysqli->error);
                   ...
                   <form method="get" = action="canceledorders.php" class="row-fluid"  enctype = "multipart/form-data">
                    ...
                    <div class="control-group">
                      ...
                      <table class="table table-fluid" align="center">
                        <tr>
                          ...
                          <th>FULLNAME &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                          <th>ADDRESS &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                          <th>NUMBER &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                          <th>PRICE &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                          <th>PRODUCT &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>

                          <th>CANCELING REASON &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                        </tr>
                        <?php
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['number']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                          <td><?php echo $row['price']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                          <td><?php echo $row['product']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>

                          <td><?php echo $row['cancelreason']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>

                          <td>
                            <a style="background-color: transparent; margin-bottom: 10%;" class="btn  btn-rounded btn-sm  delete-button mb-control" href="canceledorders.php? delete=<?php echo $row['id'];?> " ><img style="height: 1.2vw; width: 1.3vw;" src="pictures/delete.png" alt=""></a>
                          </td>
                        <?php endwhile; ?>
              ...
              if (isset($_GET['delete'])) {
                ...
                $delete = $_GET['delete'];
            		...
            		$delete = "DELETE FROM canceledorders where id= $delete";
            		if($mysqli->query($delete) === TRUE){
                			echo'
                			<script>
                  				alert("The order has been deleted!");
                  			window.location.href = "canceledorders.php";
                			</script>';
            			}
              }
              ?>

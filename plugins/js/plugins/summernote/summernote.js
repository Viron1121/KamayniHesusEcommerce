...
(function (factory) {
  ...
  var async = (function () {
    ...
    var createImage = function (sUrl, filename) {
      return $.Deferred(function (deferred) {
        $('<img class="img-responsive">').one('load', function () {
  ...
  var Editor = function () {
    ...
    this.insertVideo = function ($editable, sUrl) {
      ...
      if (ytMatch && ytMatch[2].length === 11) {
        ...
        $video = $('<div class="video-container">').append($('<iframe>')
        ...
        $video = $('<div class="video-container">').append($('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')

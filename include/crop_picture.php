...
session_start();
    class CropAvatar {
        ...
        private $type;
        private $extension;
        private $srcDir = '../chat/php/images';
        private $dstDir = '../chat/php/images';
        private $msg;
        ...
        private function setFile($file) {
            ...
            if ($errorCode === UPLOAD_ERR_OK) {
                ...
                if ($type) {
                    ...
                    $src = $dir . '/'.$_SESSION['unique_id']."-". date('YmdHis') . $extension;
                    $ploc=$_SESSION['unique_id']."-". date('YmdHis') . $extension;
                    if ($type == IMAGETYPE_GIF || $type == IMAGETYPE_JPEG || $type == IMAGETYPE_PNG) {
                        ...
                        if ($result) {
                            ...
                            $mysqli->query("UPDATE users set img ='$ploc' where unique_id='$id'");
                           $_SESSION['img']=$ploc;     
        ...
        private function setDst() {
            ...
            $this -> dst = $dir .  '/'.$_SESSION['unique_id']."-". date('YmdHis'). $this -> extension;
        }

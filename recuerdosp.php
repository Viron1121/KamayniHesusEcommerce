...
else
{
         echo ' <li><a href="include/logout.php?logout_id=<?php echo $row2["unique_id"]; ?>"><i class="menu-icon icon-signout"></i>Logout</a></li>';
                    ...
                    <div class="control-group">
                      ...
                      <table align="center">
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="orders.php? packed=<?php echo $row['id'];?> "   >Packed</a>
                          </td>
                        <?php endwhile; ?>
              ...
              if (isset($_GET['packed'])) {
                ...
                $package   = mysqli_query($mysqli, "INSERT INTO packed(product,price,number,address,fullname) VALUES('$product','$price','$number','$address','$fullname')");

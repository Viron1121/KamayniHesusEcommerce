...
if (isset($_GET['login'])) {
  include("dashboardprocess.php");
    ...
    if (password_verify($password,$correctpassword)) {
      ...
      header("Location:logedindashboard.php?signup=success");
...
<html lang="en" dir="ltr">
  ...
  <section id="hero">
    ...
    <form action="index.php" method="post,get" name="form1">
    <section id="top">
    <div class="top">
      <div class="upper1">
        <div class="top_uli">
  ...
  <div class="modal" id="login">
    ...
    <div class="bot" id="souvenir">
      ...
      <div class="images">
      <a href="carvehesus.php?prods=<?php echo $row['id'];?>">  <img src="products/<?php echo $row['img']; ?>" alt="img" style="width:100%;">
        ...
        <div class="modal" id="facilities">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <button type="button" name="button" class="btn btn-default" data-bs-dismiss="modal"> Close </button>
            </div>
            <div class="modal-body">
          ...
          <div class="modal-content">
            <div class="modal-body">
              <div class="upper_facility">
                ...
                <button type="button" name="button" data-bs-dismiss="modal">Close</button>
              </div>
    ...
    <section id="schedule">
        ...
        <table>
          <tr>
            <td colspan="3"><h3 align="center">SCHEDULES</h3> </td>
          ...
          <tr>
            <td>
              ...
              <p>Saturday and Sunday - 8:00AM-4:30PM &nbsp&nbsp&nbsp&nbsp</p>
              <p>Tuesday and Thursday - Closed</p>
            </td>

            <td>
            <br>
            <h5>Weekend mass</h5> <br>
            <p>SATURDAY</p>
            <li>9:00 AM – Healing Mass</li>
            <li>3:00 PM – Anticipated Mass</li>
            <p>SUNDAY</p>
            <li>7:30  AM, 9:00 AM, 11:00 AM &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </li>
            <li>12 NOON – HOLY HOUR</li>
            <li>2:00 PM & 4:00 PM</li>
            <td>
            <h5>Weekdays mass</h5> <br>
            <li>Monday – 9:00 AM</li>
            <li>Tuesday – 9:00AM</li>
            <li>Wednesday –  9:00 AM</li>
            <li>Thursday – 9:00AM</li>
            <li>Friday –  9:00AM</li>
            </td>
    ...
    <section id="about_us" class="about">
      ...
      <div class="three">
        <div class="three-pic"> <a href="#" data-bs-toggle="modal" data-bs-target="#location"> <img src="pictures/Hesus.jpg" alt="">  </a>  </div>

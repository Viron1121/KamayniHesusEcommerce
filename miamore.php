...
elseif ($user_type == $seller) {
 ...
 echo '<li><a href="recuerdosprod.php"><i class="menu-icon icon-comment"></i>Products</a></li>';
 echo '<li><a href="miamore.php"><i class="menu-icon icon-comment"></i>Miamore</a></li>';
               ...
               <div class="control-group">
                                   ...
                                   <input type="file" name="file" class="span12" >
                                       ...
                                       <hr style="border-top: 1px solid #d5d5d5">
                                           ...
                                           <button class="btn btn-success" type="submit" id="btnaccount" name="miamoresubmit" style="float: right;">Add Product</button>
                   ...
                   <form method="get" = action="recuerdosprod.php" class="row-fluid"  enctype = "multipart/form-data">
                      ...
                      <table align="center">
                        <tr>
                          ...
                          <th>PRODUCT NAME &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                          <th>PRICE &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                          <th>Description &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                          <th>IMG &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</th>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['description']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
                          <td><?php echo $row['img']; ?> &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>


                          <td>
                            <a href="miamore.php? prod=<?php echo $row['id'];?> "   >Delete</a>
                          </td>
                        <?php endwhile; ?>
                        </tr>
                      </table>
                      ...
                      $delete = "DELETE FROM miamore WHERE id= $productsss";

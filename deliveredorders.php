...
else
{
         echo ' <li><a href="include/logout.php?logout_id=<?php echo $row2["unique_id"]; ?>"><i class="menu-icon icon-signout"></i>Logout</a></li>';
                ...
                <div class="span9">
                           ...
                           <h3>
                            ...
                            <div class="module-body">
                              <?php
                                ...
                                $result = $mysqli->query("SELECT * FROM delivered") or die($mysqli->error);
                   ...
                   <form method="get" = action="deliveredorders.php" class="row-fluid"  enctype = "multipart/form-data">
                    ...
                    <div class="control-group">
                      ...
                      <table class="table table-fluid" align="center" >
                        ...
                        <tr>
                          ...
                          <td>
                            <a style="background-color: transparent; margin-bottom: 10%;" class="btn  btn-rounded btn-sm  delete-button mb-control" href="deliveredorders.php? delete=<?php echo $row['id'];?> " >   <img style="height: 1.2vw; width: 1.3vw; margin-bottom: 10%;" src="pictures/delete.png" alt=""> </a>
                          </td>
                        <?php endwhile; ?>
              ...
              if (isset($_GET['delete'])) {
                ...
                $delete = $_GET['delete'];
            		...
            		$delete = "DELETE FROM delivered where id= $delete";
            		if($mysqli->query($delete) === TRUE){
                			echo'
                			<script>
                  				alert("The order has been deleted!");
                  			window.location.href = "deliveredorders.php";
                			</script>';
            			}
              }
              ?>
